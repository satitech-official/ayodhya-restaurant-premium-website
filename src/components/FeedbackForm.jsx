  ...
  return (
    <form onSubmit={submit} className="rounded-[2rem] bg-soft p-6 shadow-soft ring-1 ring-sand/60 sm:p-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          <label htmlFor="fb-phone" className={labelCls}>
            Phone
          </label>
      ...
      <button
        ...
        className="mt-6 flex w-full items-center justify-center gap-2 rounded-full bg-charcoal px-7 py-4 text-sm font-bold uppercase tracking-[0.12em] text-soft transition hover:bg-espresso disabled:opacity-60"
      >
        {status === "loading" ? (
          <>
